 ...
 * Plugin URI:  http://github.com/bombozama/event-post-type
 * Description: Enables an event post type, taxonomy and metaboxes.
 * Version:     1.0.2
...
require plugin_dir_path( __FILE__ ) . 'includes/class-post-type-public.php';
...
$post_type_metaboxes = new Event_Post_Type_Metaboxes;
$post_type_metaboxes->init();

# Initialize frontend actions
$post_type_public = new Event_Post_Type_Public;
